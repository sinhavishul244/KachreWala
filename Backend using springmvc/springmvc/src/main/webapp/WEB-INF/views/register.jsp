...
<html>
    ...
    <body style="background: url(plastic-waste.jpg);background-size: cover;background-attachment: fixed;">
        <div class="container">
            <div class="row">
                <div class="col m6 offset-m3">
                    <div class="card indigo lighten-5" style="padding: 10px;">
                        <div class="card-title center-align">
                            ...
                            <a href="/springmvc/login">Click here to login</a>
                        ...
                        <div class="card-content">
                            <div class="form center-align">
                                <form action="Register" method="post" id="myform">
                                    ...
                                    <input type="text" name="userAddress" placeholder="Enter your Address" size="500">
